...
class Drawing(models.Model):
    ...
    square = models.CharField(max_length=200, help_text="Общая площадь, м^2")
    weight = models.CharField(max_length=200, help_text="Масса, кг")
    ...
    quantityA4 = models.CharField(max_length=200, help_text="Кол-во A4")
    name = models.CharField(max_length=200, help_text="Название изделия")
