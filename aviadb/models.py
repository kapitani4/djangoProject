...
class Drawing(models.Model):
    ...
    square = models.CharField(max_length=200, help_text="Площадь")
    weight = models.CharField(max_length=200, help_text="Масса")
    ugs = models.CharField(max_length=200, help_text="UGS")
    designConcept = models.CharField(max_length=200, help_text="Design Concept")
    ...
    laborIntensity = models.CharField(max_length=200, help_text="Трудоемкость")
    dc = models.CharField(max_length=200, help_text="DC")
    complexity = models.CharField(max_length=200, help_text="Сложность оснастки")
